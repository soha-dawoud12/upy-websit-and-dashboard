(function (e) {
    e.fn.multiSelect = function (t) {
        ...
        return this.each(function () {
            ...
            n.append('<div id="multiSelectClick" style="color: #4468EC">Add Category</div>');
            t.append('<div id="multiSelectElements" class=" "></div>');
            var i = e("#multiSelectElements");
            for (var s = 0; s < r.elements.length; s++) {
                i.append('<div class="multiSelectElement">' + r.elements[s] + "</div>")
            }
            e("#multiSelectClick").click(function () {
                if (i.is(":visible")) {
                    i.slideUp("fasts")
            ...
            e(document).on("click", ".multiSelectElement", function () {
                var t = e("#multiSelectElementsSelected").html();
                var n = '<div class="multiSelectElementSelected">' + e(this).html() + '<span class="multiSelectClose">X</span></div>';
                e(this).remove();
                if (t.trim() == r.title) {
                    t = ""
                }
            ...
            e(document).on("click", ".multiSelectClose", function () {
                ...
                t = t.replace('<span class="multiSelectClose">X</span>', "");
                e(this).parent().remove();
                i.append('<div class="multiSelectElement">' + t + "</div>");
